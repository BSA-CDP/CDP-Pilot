...
#include <Arduino.h>
#include <Wire.h>  // Add this to ensure Wire object is included
...
class LIS3MDL
{
  public:
    ...
    void setWire(TwoWire &wirePort = Wire1) { _wire = &wirePort; } // Added function to set Wire object
  ...
  private:
    ...
    uint8_t address;
    TwoWire *_wire = &Wire1;  // Added member to hold Wire object, defaulted to Wire1
